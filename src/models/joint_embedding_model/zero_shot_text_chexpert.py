...
def main(args):
    ...
    query_embeddings, query_labels = getTextEmbeddings(heads, transformerModel, tokenizer)
    ...
    print(precAt(query_labels, candLabels, 1))
    print(precAt(query_labels, candLabels, 5))
    print(precAt(query_labels, candLabels, 10))
    print(precAt(query_labels, candLabels, 50))
